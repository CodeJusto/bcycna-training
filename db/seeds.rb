...
Course.create(name:"George's invaluable insights", description:"Make millions of dollars with BCYCNA veteran George Affleck's sage advice", image: "newspaper.jpg")
Course.create(name:"Shoults Weekly Shit", description:"We interview BCYCNA past president Tim Shoults to find out what interesting things he's found this this time. Updated weekly.", image: "handshake.jpg")
